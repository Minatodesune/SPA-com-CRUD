...
function menu(link){
  ...
  .catch(error => conteudo.innerHTML = '<h1>Página não encontrada</h1>');
}

const tbody = document.querySelector('#dados');
const url = 'https://poggers-ecae3-default-rtdb.firebaseio.com/'
const nome = document.querySelector('#nome');
const email = document.querySelector('#email');
const senha = document.querySelector('#Art');
